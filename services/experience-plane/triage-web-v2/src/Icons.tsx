...
export function GithubIcon(props: IconProps) {
  ...
  return (
    <svg {...a} viewBox="0 0 24 24">
      <path d="M12 .5a12 12 0 0 0-3.793 23.393c.6.11.82-.26.82-.577v-2.03c-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.09-.745.083-.73.083-.73 1.205.084 1.84 1.238 1.84 1.238 1.07 1.835 2.807 1.305 3.492.998.108-.775.418-1.305.76-1.606-2.665-.305-5.467-1.333-5.467-5.93 0-1.31.468-2.381 1.235-3.221-.124-.305-.535-1.53.116-3.188 0 0 1.008-.323 3.3 1.23a11.46 11.46 0 0 1 3.003-.404c1.02.005 2.047.138 3.003.404 2.29-1.553 3.296-1.23 3.296-1.23.654 1.658.243 2.883.12 3.188.77.84 1.233 1.911 1.233 3.221 0 4.61-2.807 5.62-5.48 5.92.43.37.815 1.096.815 2.21v3.277c0 .32.216.694.825.576A12 12 0 0 0 12 .5z" />
    </svg>
  );
}
